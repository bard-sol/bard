...
async function renderVaultPanel(p){
  ...
  el.innerHTML=vaultBadgeHtml(p)+
    ...
    (addr?'':'<button type="button" class="btn btn--solid" id="btn-create-vault">Create 2-of-2 vault</button><span class="hint">One Phantom signature. We add your wallet + Bard as the two members.</span>')+
